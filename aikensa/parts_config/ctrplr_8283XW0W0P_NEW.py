...
pitchSpecLH = [85, 87, 98, 98, 78, 61, 52, 38, 37, 28]
pitchSpecRH = [28, 37, 38, 52, 61, 78, 98, 98, 87, 85]
pitchToleranceLH = [2.0, 1.7, 1.7, 1.7, 1.7, 1.7, 1.7, 1.7, 1.7, 1.7]
pitchToleranceRH = [1.7, 1.7, 1.7, 1.7, 1.7, 1.7, 1.7, 1.7, 1.7, 2.0]
clipSpecLH = [2, 1, 0, 0, 0, 0, 3, 3, 3, 0, 0, 0, 1] #white is 0, brown is 1, yellow is 2, orange is 3
clipSpecRH = [0, 1, 1, 1, 3, 3, 3, 1, 1, 1, 1, 0, 2] #white is 0, brown is 1, yellow is 2, orange is 3

dailytenken01Spec = [100, 100, 100, 100, 100]
dailytenken01Tolerance = [1.7, 1.7, 1.7, 1.7, 1.7]
